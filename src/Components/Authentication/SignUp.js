...
const SignUp = () => {
  ...
  return (
    <div className="flex flex-col flex-wrap justify-center items-center">
      <p className="font-roboto font-bold text-[#fff] text-3xl m-6">
        Create Account
      </p>
      {isLoading && (
      ...
      {!isLoading && (
        <form
          ...
          className="flex flex-col flex-no-wrap justify-center items-center min-[320px]:w-[280px] sm:w-[360px] lg:w-[450px] rounded-[25px] pt-6 "
        >
          <Input
            className="bg-[#0D103C] min-[320px]:w-[250px] sm:w-[300px] lg:w-[400px] h-[75px] text-[#fff] px-4 mx-4 my-2"
            id="name"
            type="text"
            placeholder="Name"
            name="name"
